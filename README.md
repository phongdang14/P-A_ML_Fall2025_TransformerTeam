...
- Folder ```trim_time/``` is related to our attempt to fine-tune the fitting process by limitting the lightcurves to 20 days for Model 1 and 15 days for Model 2 before the explosion. The performance was worse, thus we did not report in the main notebook.
